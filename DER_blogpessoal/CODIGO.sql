...
-- -----------------------------------------------------
-- Table `Blog`.`tb_usuarios`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Blog`.`tb_usuarios` (
...
-- Table `Blog`.`tb_temas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Blog`.`tb_temas` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `Blog`.`tb_postagens`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Blog`.`tb_postagens` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
